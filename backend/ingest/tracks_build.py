...
STATIC: dict[str, tuple[float, float, int, float, float, float]] = {
    ...
    "monte_carlo": (43.7347, 7.4206, 78, 3.337, 0.95, 1.0),
    ...
    "marina_bay": (1.2914, 103.8640, 62, 4.940, 0.85, 2.0),
    ...
    "abu_dhabi": (24.4672, 54.6031, 58, 5.281, 0.50, 2.5),
    ...
    "al_daayen": (25.4900, 51.4542, 57, 5.419, 0.50, 4.5),
